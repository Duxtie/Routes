					    ...
					    <div class="col-xs-12 col-xs-offset-0 col-sm-4 col-sm-offset-4 col-md-4 col-md-offset-4">
						    ...
						    <div class="">
						          ...
						          <form class="searchform" method="get">
						            ...
						            <h3 class="widget-title">Old Password</h3>
						            <input name="pwd" value="your password" type="password" id="password" placeholder="Password">
						            <h3 class="widget-title">New Password</h3>
							        <input name="pwd" value="" type="password" id="password" placeholder="Password" autocomplete="off">
									<h3 class="widget-title">Retype New Password</h3>
